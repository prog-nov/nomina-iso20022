...
from openerp.addons.hr_payroll.controllers.main import HrPayroll

import logging
_logger = logging.getLogger(__name__)


class Extension_HrPayrollController(HrPayroll):
    ...
    def get_payroll_report_print(self, list_ids='', **post):
        ...
        for payslip in payslips:
            if not payslip.struct_id or not payslip.struct_id.report_id:
                report = request.env.ref('nomina_cfdi_ee.report_payslips', False)
            else:
